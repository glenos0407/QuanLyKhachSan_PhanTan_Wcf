    ...
    public class BaoCao_WCF : IBaoCao_WCF
    {
        ...
        public List<BaoCao_Ent> GetBaoCaos(DateTime dt)
        {
            ...
            foreach (var chiTietBaoCao in dsBaoCaoTong)
            {
                ...
                pck_ent.Ngay_check_in = (DateTime)chiTietBaoCao.ngay_check_in;
                pck_ent.Gio_check_in = (TimeSpan)chiTietBaoCao.gio_check_in;
                pck_ent.Ngay_check_out = (DateTime)chiTietBaoCao.ngay_check_out;
                pck_ent.Gio_check_out = (TimeSpan)chiTietBaoCao.gio_check_out;
